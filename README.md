...
We will not be distributing compiled build! Use any you find online at your own risk!

## License

uzuy is licensed under the GPLv3 (or any later version). Refer to the [LICENSE.txt](https://github.com/ume-uzuy/uzuy/blob/master/LICENSE.txt) file.
